    ...
    <div style={{ fontFamily: "Rethink Sans, sans-serif" }}>
     ...
     {/* ================= HERO SECTION ================= */}
      <section
        style={{
          background:
            "linear-gradient(to right, #99D5FB 0%, #FFFFFF 50%, #99D5FB 100%)",
          padding: "clamp(60px, 8vw, 120px) 20px",
          display: "flex",
          justifyContent: "center",   // ✅ center whole layout horizontally
        }}
      >
        <div
          style={{
            ...
            display: "flex",
            alignItems: "center",
            justifyContent: "center",  // ✅ keeps both sides centered together
            gap: "80px",
            flexWrap: "wrap",
          }}
        >

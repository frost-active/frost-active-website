...
const Footer = () => {
  ...
  const [successMessage, setSuccessMessage] = useState(""); // ✅ show success under button
  ...
  const handleSubscribe = async (e) => {
    ...
    try {
      ...
      setSuccessMessage("✅ Thank you for subscribing! Stay tuned for updates.");
    } catch (error) {
    ...
    <footer className="relative bg-blue-50 px-4 sm:px-6 lg:px-8 flex flex-col">
      <div className="flex-1">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 text-center md:text-left items-start">
          ...
          {/* Brand Info */}
          <div className="flex flex-col items-center md:items-start gap-4 relative -top-11">
          ...
          {/* Contact Info */}
          <div className="relative -top-12 md:pl-6 md:-ml-16 flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-1 text-sm text-[#021637] font-[Roboto]">
              ...
              <li className="flex items-center justify-center md:justify-start gap-2">
                <img src="/images/location.png" alt="Location" className="h-5 w-5" />
                <span>Sandstraße 26, 57072 Siegen, Germany</span>
              </li>
            </ul>
          </div>
